...
<p class='editable'>hola editable</p>
<p class='no_editable'>no editablea</p>
                  ...
                  // 200 es el código de estado HTTP para "OK"
                   ...
                   cajaContenidos.innerHTML+="<p>NADA QUE MOSTRAR</p>";}
                    ...
                    switch(get_pagina){ 
                        ...
                        "<img src='"+contenidos[0].texto+"' style='margin-left:32px;margin-right:47px;width:296px;height:296px;border:1px solid black;' id='contenido-img-"+contenidos[0].id_contenido+"'>"
    ...
    formulario.addEventListener('submit', function(event) {
        ...
        enviarFormulario()
                        ...
                        if(listaDatosFicha['error']){mostrarModal("ERROR. NO SE PUDO CARGAR LA FICHA. CONSULTE CON EL SUPERADMINISTRADOR");}
                            ...
                            cajaContenidos.innerHTML.innerText = ""; // Limpiar antes de comenzar
cajaContenidos.innerHTML+="<div id='"+"ficha-"+listaDatosFicha.id_ficha+"' style='padding-top:47px;padding-bottom:57px;' onclick='editadorFicha("+listaDatosFicha.id_ficha+")'>"+
...
"<div class='col-sm col-12' style='border:1px solid rgb(0, 0, 0);'><div class='row' style='height:40%;padding:12px;'><div class='col' style='border:1px solid black;'><img src='"+listaDatosFicha.imagen+"' class='img-fluid' style='width: 100%;height: 100%;max-height: 271px;min-height:223px;'></div></div>"+
...
/*<span class='negrita'>Alias:"+listaDatosFicha.alias+"</span></p>*/
            ...
            */              for(let i=0;i<listaLibros.length;i++){
                            ...
                            "<img src='"+listaLibros[i].imagen+"' class='img-fluid' style='width: 100%; height: 100%;'>"+
                            "</div>"+
...
"</div>";
            ...
            eliminarONCLICK(<?php if(isset($_SESSION['nombre'])){echo json_encode(!($superadminBool || ($_SESSION['nombre'] == basename(dirname(__FILE__)))));} else echo json_encode(false); ?>);
        };

function eliminarONCLICK(boolean){ 
    if(boolean){
